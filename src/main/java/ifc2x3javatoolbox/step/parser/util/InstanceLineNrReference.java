 ...
 */
public class InstanceLineNrReference implements CloneableObject
{
	private int lineNr = -1;
	public static long counter = 0;

	public InstanceLineNrReference(String lineNr)
	{
		this.lineNr = Integer.parseInt(lineNr);
		counter++;
	}

	public InstanceLineNrReference(Integer lineNr)
	{
		this.lineNr = lineNr;
		counter++;
	}
